    ...
    export default {
        ...
        methods: {
            ...
            checkIfUserExists() {
                ...
                ApiService.post('/user/exists', {email: this.form.email})
                    .then(res => {
            ...
            sendForm() {
                const apiService = this.editData ?
                    ApiService.put('/user/' + this.editData.uuid, this.form) :
                    ApiService.post('/user', this.form)
                ;
            ...
            deleteUser(code) {
                if (code === 'yes') {
                    ...
                    ApiService.delete('/user/' + this.editData.uuid).then(res => {
